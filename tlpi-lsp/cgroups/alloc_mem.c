...
/* alloc_mem.c
  ...
  Allocate blocks of memory, as specified by command-line arguments.
  This program is useful for small experiments with the 'cpu' and
  'cpuacct' cgroup controllers.
*/
#include "tlpi_hdr.h"
...
main(int argc, char *argv[])
{
    ...
    for (j = 0; (numAllocs == -1) || (j < numAllocs); j++) {
        ...
        /* Make sure memory is actually allocated in VM by touching
           every page */
